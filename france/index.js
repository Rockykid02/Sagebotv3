...
export const MESSAGES = {
  ...
  alive: {
    checking: '🔄 Checking Sage-Bot v3 status...',
    online: `🤖 *Sage-Bot v3* ✅ *Online*
...
🙏 *Credits:* Franceking`,
  ...
  help: {
    ...
    aliases: 'Aliases',
    usage: 'Use',
    powered: '_⚡ Powered by Digital Dynamo Lab_',
  ...
  playlist: {
    ...
    fetching: '⏳ *Sage-Bot v3* is fetching playlist information... Please wait.',
  ...
  fb: {
    ...
    caption: '*Title:* {title}\n\n*Direct Link:* {url}',
    videoCaption: '_╰►FB VIDEO DOWNLOADED BY_ *Sage-Bot v3*'
  },
  ...
  imageDl: {
    ...
    caption: '📸 *Sage-Bot v3* Image Downloader (High Quality)',
  ...
  imagine: {
    ...
    caption: '_✨ Created by Sage-Bot v3_'
  },
  ...
  insta: {
    ...
    caption: '_*✨ Downloaded by Sage-Bot v3*_'
  },
  ...
  logo: {
    ...
    caption: '*Sage-Bot v3 - Logo Generator*',
  ...
  posts: {
    ...
    caption: '📸 _✨ Downloaded by Sage-Bot v3_',
    videoCaption: '🎥 _✨ Downloaded by Sage-Bot v3_'
  },
  ...
  twitter: {
    ...
    caption: '🎥 *Sage-Bot v3 X DOWNLOADER*\n\n📦 *Quality:* {quality}\n\n_✨ Downloaded successfully!_',
    timeout: '⏱️ *Request timed out.* The server took too long to respond. Please try again.',
  ...
  videoDl: {
    ...
    caption: '🎥 *Sage-Bot v3* Video Downloader (High Quality)',
  ...
  wallpaper: {
    ...
    caption: "*POWERED BY Sage-Bot v3*"
  },
  ...
  whatsapp: {
    ...
    vv: {
      caption: '*REVEALED BY Sage-Bot v3*'
    },
    details: {
      noReply: 'Please reply to a message to view its raw details.',
      result: '*Sage-Bot v3 Message Details:*\n```\n{part}\n```',
  ...
  ping: {
    pong: '🏓 Pong!\n⏱️ *_Sage-Bot v3 Speed: {latency} ms_*'
  },
  
  uptime: {
    uptime: '*_Sage-Bot v3 UPTIME: {uptime}_*'
  },
